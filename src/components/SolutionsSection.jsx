        ...
        <div className="relative grid grid-cols-1 rounded-2xl md:grid-cols-2 gap-6 overflow-hidden overflow-y-scroll scrollbar-hide">
          ...
          {solutions.map((solution, index) => (
            ...
            >
              ...
              <div
                className={`bg-white p-6 rounded-xl shadow-lg border border-border group hover:shadow-xl transition-all duration-300 relative overflow-hidden service-card h-full min-h-[340px] flex flex-col  ${index % 2 === 0 ? 'rotate-2' : '-rotate-2'}`}
              >
